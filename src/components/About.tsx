              ...
              <div className="relative z-10 bg-white dark:bg-slate-700 p-6 rounded-lg shadow-xl">
                  ...
                  {[
                    ...
                    <div key={skill.name}>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300">{skill.percentage}%</span>
                      </div>
                      <div className="w-full bg-slate-200 dark:bg-slate-600 rounded-full h-2">
                        <div
                          ...
                          style={{ width: `${skill.percentage}%`, animationDelay: '600ms' }}
                        ></div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="mt-8">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">University Name, 2018-2022</p>
                  </div>
                </div>
              </div>
            </div>
